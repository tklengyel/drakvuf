...
static const char* win_offset_names[__WIN_OFFSETS_MAX][2] =
{
    ...
    [OBJECT_HEADER_TYPE] = { "_OBJECT_HEADER", "Type" },
    [OBJECT_HEADER_NAME_INFO_OFFSET] = { "_OBJECT_HEADER", "NameInfoOffset" },
