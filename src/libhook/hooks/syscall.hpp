...
public:
     ...
     */
    template<typename Params = call_result_t>
    static auto create(drakvuf_t, std::string syscall_name, callback_t cb)
...
protected:
     ...
     */
    syscall_hook(drakvuf_t, std::string syscall_name, callback_t cb);
};
