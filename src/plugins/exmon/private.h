...
#define CSV_FORMAT64 "exmon,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x"
...
#define DEFAULT_FORMAT64 "[EXMON] EXCEPTION_RECORD: %x EXCEPTION_CODE: %x RIP: %x RAX: %x RBX: %x RCX: %x RDX: %x RSP: %x RBP: %x RSI: %x RDI: %x R8: %x R9: %x R10: %x R11:%x"

#define CSV_FORMAT_USER ",%d,%s\n" 

#define DEFAULT_FORMAT_USER " PID: %d NAME: %s\n"
