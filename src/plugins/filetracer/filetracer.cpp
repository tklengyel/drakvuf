...
static event_response_t objattr_read(drakvuf_t drakvuf, drakvuf_trap_info_t* info, addr_t attr)
{
    ...
    unicode_string_t* file_root_us = drakvuf_get_filename_from_handle(drakvuf, info, file_root_handle);
...
static void print_rename_file_info(vmi_instance_t vmi, drakvuf_t drakvuf, drakvuf_trap_info_t* info, addr_t src_file_handle, addr_t fileinfo)
{
    ...
    unicode_string_t* src_file_us = drakvuf_get_filename_from_handle(drakvuf, info, src_file_handle);
    if ( !src_file_us )
    {
    ...
    {
        unicode_string_t* dst_file_root_us = drakvuf_get_filename_from_handle(drakvuf, info, dst_file_root_handle);
