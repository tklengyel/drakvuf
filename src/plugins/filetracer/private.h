...
enum
{
    ...
    FMODE_NOWAIT = 0x8000000,
    FMODE_NOACCOUNT = 0x20000000,
};

static const flags_str_t linux_file_flags =
    {
        REGISTER_FLAG(FMODE_READ),
        REGISTER_FLAG(FMODE_WRITE),
        REGISTER_FLAG(FMODE_LSEEK),
        REGISTER_FLAG(FMODE_PREAD),
        REGISTER_FLAG(FMODE_PWRITE),
        REGISTER_FLAG(FMODE_EXEC),
        REGISTER_FLAG(FMODE_NDELAY),
        REGISTER_FLAG(FMODE_EXCL),
        REGISTER_FLAG(FMODE_WRITE_IOCTL),
        REGISTER_FLAG(FMODE_32BITHASH),
        REGISTER_FLAG(FMODE_64BITHASH),
        REGISTER_FLAG(FMODE_NOCMTIME),
        REGISTER_FLAG(FMODE_RANDOM),
        REGISTER_FLAG(FMODE_UNSIGNED_OFFSET),
        REGISTER_FLAG(FMODE_PATH),
        REGISTER_FLAG(FMODE_ATOMIC_POS),
        REGISTER_FLAG(FMODE_WRITER),
        REGISTER_FLAG(FMODE_CAN_READ),
        REGISTER_FLAG(FMODE_CAN_WRITE),
        REGISTER_FLAG(FMODE_OPENED),
        REGISTER_FLAG(FMODE_CREATED),
        REGISTER_FLAG(FMODE_NONOTIFY),
        REGISTER_FLAG(FMODE_NOWAIT),
        REGISTER_FLAG(FMODE_NOACCOUNT),
};
